...
let package = Package(name: "BlinkIDVerify",
                      ...
                      targets: [
                        .binaryTarget(
                            name: "BlinkIDVerify",
                            url: "https://github.com/BlinkID/blinkid-verify-ios/releases/download/v3.8.0/BlinkIDVerify.xcframework.zip",
                            checksum: "3b7db378bd28647933174743087a01d2d43f0907afc4d09dd59b16c4f433e625")
                      ],
